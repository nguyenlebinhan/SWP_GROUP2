...
public class UserDAO {
    ...
    public User getUserByEmail(String email) {
        ...
        String SQL = "SELECT u.userId,u.password,u.fullName,u.dob,u.address,r.roleName FROM Users u JOIN Roles r on r.roleId = u.roleId WHERE u.email = ?  ";
        try(Connection conn = dbContext.getConnection();
            PreparedStatement ps = conn.prepareStatement(SQL)){
            ...
            try(ResultSet rs = ps.executeQuery()){
                if(rs.next()){
                    ...
                    User user = new User (userId,email,password,fullName,dateOfBirth,address,roleName);
