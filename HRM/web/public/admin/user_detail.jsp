...
<div class="main-content">
    ...
    <div class="page-header">
        <a href="${pageContext.request.contextPath}/v1/admin/user-list" class="back-btn" title="Quay lại">
            <i class="fa fa-arrow-left"></i>
        </a>
        <h5><i class="fa fa-user me-2" style="color:#ff8c00"></i>Chi tiết người dùng</h5>
    </div>
