...
<div class="main-content">
    ...
    <div class="d-flex justify-content-end mb-4">
        <a href="${pageContext.request.contextPath}/v1/systemadmin/role/add" class="btn-add">
             Thêm vai trò
        </a>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display:flex;gap:6px;flex-wrap:wrap">
                                            ...
                                            <a href="${pageContext.request.contextPath}/v1/systemadmin/role/update?id=${r.roleId}" class="btn-action btn-view">
                                                Sửa
                                            </a>
                                            <c:if test="${r.roleCode != 'SA' && r.roleCode != 'BA'}">
                                            <a href="${pageContext.request.contextPath}/v1/systemadmin/permissions/edit?id=${r.roleId}" class="btn-action" style="background:#fef3c7;color:#92400e;border:1px solid #fde68a">
                                                 Phân quyền
                                            </a>
                                            </c:if>
                                            <c:choose>
                                                ...
                                                <c:when test="${r.isActive == 1}">
                                                    <a href="${pageContext.request.contextPath}/v1/systemadmin/user/status-role?id=${r.roleId}&status=0"
                                                ...
                                                <c:otherwise>
                                                    <a href="${pageContext.request.contextPath}/v1/systemadmin/user/status-role?id=${r.roleId}&status=1"
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <a href="${pageContext.request.contextPath}/v1/systemadmin/role/delete?id=${r.roleId}" class="btn-action btn-delete">
                                                        Xóa
                                                    </a>
                                                </c:otherwise>
