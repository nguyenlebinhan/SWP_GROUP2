...
<div class="sidebar">
            ...
            <a href="${pageContext.request.contextPath}/v1/admin/dashboard"><i></i> Tổng quan</a>
<!--            <a><i class="fa fa-briefcase"></i> Công việc</a>-->
            <a href="${pageContext.request.contextPath}/v1/admin/user-list" ><i></i> Người dùng</a>
<!--            <a><i class="fa fa-clock"></i> Chấm công</a>
            ...
            <a href="${pageContext.request.contextPath}/v1/admin/role-list"><i></i> Phân quyền</a>
