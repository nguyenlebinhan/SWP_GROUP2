                            ...
                            <c:forEach var="h" items="${holidays}" varStatus="st">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/v1/businessadmin/holiday/edit?id=${h.holidayId}"
                                           class="btn btn-soft me-1">Sửa</a>
                                        <button type="button" class="btn btn-danger-soft"
                                                onclick="confirmDelete(${h.holidayId}, '<c:out value="${h.holidayName}"/>')">
                                            Xóa
                                        </button>
                                    </td>
                                </tr>
