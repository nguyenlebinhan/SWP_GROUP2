        ...
        <div class="col-auto col-md-3 col-xl-2 px-0 sidebar">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 w-100">
                    ...
                    <li class="nav-item"><a href="${pageContext.request.contextPath}/v1/manager/contract/pending" class="nav-link text-warning active">Hợp đồng chờ duyệt</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col py-3 main-content">
            ...
            <c:if test="${contract != null}">
                ...
                <div class="text-end mt-4">
                    <a href="${pageContext.request.contextPath}/v1/manager/contract/pending" class="btn btn-secondary me-2">Quay lại danh sách</a>
                    <c:if test="${contract.status.name() == 'PENDING_APPROVAL'}">
                        <form method="post" action="${pageContext.request.contextPath}/v1/manager/contract/approve" style="display:inline">
                            ...
                            <button type="submit" class="btn btn-success me-2" onclick="return confirm('Bạn có chắc muốn duyệt hợp đồng này?')">
