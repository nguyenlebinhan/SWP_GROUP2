...
<ul class="nav nav-pills form-type-tabs mb-4">
    <li class="nav-item">
        <a class="nav-link ${param.active == 'leave' ? 'active' : ''}"
           href="${pageContext.request.contextPath}/v1/manager/forms/leave/new">
            Đơn Nghỉ Phép
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link ${param.active == 'complaint' ? 'active' : ''}"
           href="${pageContext.request.contextPath}/v1/manager/forms/complaint/new">
            Đơn Khiếu Nại
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link ${param.active == 'transfer' ? 'active' : ''}"
           href="${pageContext.request.contextPath}/v1/manager/forms/transfer/new">
            Đơn Thuyên Chuyển
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link ${param.active == 'dependent' ? 'active' : ''}"
           href="${pageContext.request.contextPath}/v1/manager/forms/dependent/new">
            Đăng ký người phụ thuộc
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link ${param.active == 'promotion' ? 'active' : ''}"
           href="${pageContext.request.contextPath}/v1/manager/forms/promotion/new">
