        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select name="targetDepartmentId" id="targetDepartmentId" class="form-select" onchange="filterRoles()" required>
                ...
                <div class="col-md-6">
                    <label class="form-label fw-bold">Vị trí / Chức vụ mong muốn <span class="text-danger">*</span></label>
