    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="section-card">
                <form method="get" action="${pageContext.request.contextPath}/v1/manager/forms/all"
                            ...
                            <c:choose>
                                <c:when test="${empty forms}">
                                    ...
                                    <c:otherwise>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="${pageContext.request.contextPath}/v1/manager/forms/detail?id=${f.formId}" class="text-decoration-none fw-bold">
                                                    ${f.formCode}
                                                </a>
                                            </td>
