                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a class="btn btn-sm btn-outline-primary"
                                               href="${pageContext.request.contextPath}/v1/manager/employee_info/detail?id=${emp.employeeId}">
                                                <i class="fa-solid fa-eye"></i>
                                            </a>
                                            <c:if test="${canEditEmployee}">
                                                <a class="btn btn-sm btn-outline-secondary"
                                                   href="${pageContext.request.contextPath}/v1/manager/employee_info/update?id=${emp.employeeId}">
                                                    <i class="fa-solid fa-pen"></i>
                                                </a>
                                            </c:if>
                                            <c:if test="${canAddEmploymentContract}">
                                                <a class="btn btn-sm btn-outline-success"
                                                   href="${pageContext.request.contextPath}/v1/manager/contract/add?employeeId=${emp.employeeId}">
