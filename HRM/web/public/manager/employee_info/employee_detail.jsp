                ...
                <div>
                    ...
                    <c:if test="${canReassignDept and employee.departmentId > 0}">
                        <div class="mt-2 d-flex gap-2 flex-wrap">
                            <a href="${pageContext.request.contextPath}/v1/manager/department/reassign?id=${employee.employeeId}"
                               class="btn btn-warning btn-sm">
                                <i class="fa-solid fa-right-left me-1"></i>Chuyển phòng ban
                            </a>
                            <form action="${pageContext.request.contextPath}/v1/manager/department/unassign"
