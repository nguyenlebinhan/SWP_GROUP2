...
<div class="main">
    <jsp:include page="/public/components/managerTopBar.jsp">
        ...
        <jsp:param name="backUrl" value="/v1/manager/department-list" />
    </jsp:include>
    ...
    <div class="page-card">
        ...
        <form action="${pageContext.request.contextPath}/v1/manager/add-department"
            ...
            <div class="action-bar">
                ...
                <a href="${pageContext.request.contextPath}/v1/manager/department-list" class="btn-cancel">
