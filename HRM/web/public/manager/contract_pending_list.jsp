                            ...
                            <tbody>
                                <c:forEach items="${pendingContracts}" var="contract">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="fw-medium">${contract.employee.fullName}</div>
                                            <small class="text-muted">${contract.employee.employeeCode}</small>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end pe-4">
                                            <a href="${pageContext.request.contextPath}/v1/manager/contracts/approve-preview?contractId=${contract.contractId}" class="btn btn-sm btn-outline-primary me-1">
