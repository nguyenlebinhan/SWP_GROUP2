        ...
        <div class="content-wrapper">
            ...
            <div class="card mb-4">
                <div class="card-body filter-box">
                    <form action="${pageContext.request.contextPath}/v1/contracts/history" method="get" class="row g-3 align-items-end">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="date" name="startDate" class="form-control form-control-sm" value="${param.startDate}">
                        </div>
                        <div class="col-md-2">
                    ...
                    <c:if test="${history != null and not history.isEmpty()}">
                        <div class="table-responsive">
                            ...
                            <c:forEach items="${history}" var="log">
                                ...
                                <td>ID: ${log.contract.employeeId != null ? log.contract.employeeId : 'N/A'}</td>
