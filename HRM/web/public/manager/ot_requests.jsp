    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="${pageContext.request.contextPath}/v1/manager/create-ot" class="btn btn-primary">
            ...
            <div class="section-card">
                <form action="${pageContext.request.contextPath}/v1/manager/ot-requests" method="GET" class="row g-3 align-items-end">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="${pageContext.request.contextPath}/v1/manager/ot-requests" class="btn btn-outline-secondary ms-2">Xóa bộ lọc</a>
                    </div>
                </form>
            </div>
                        ...
                        <tbody>
                            <c:forEach var="req" items="${otRequests}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/v1/manager/ot-detail?id=${req.formId}" class="btn btn-sm btn-outline-primary" title="Xem chi tiết">
