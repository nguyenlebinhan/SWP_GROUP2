...
<body>
    ...
    <div class="main">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="${pageContext.request.contextPath}/v1/manager/ot-requests" class="btn btn-outline-secondary">
                <i class="fa-solid fa-arrow-left me-1"></i> Quay lại
            </a>
        </div>

        <div class="section-card">
            <form action="${pageContext.request.contextPath}/v1/manager/create-ot" method="POST">
