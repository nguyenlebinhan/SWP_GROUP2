...
<html>
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="panel">
                <form method="get" action="${pageContext.request.contextPath}/v1/manager/salary/own" class="row g-3 align-items-end">
                    <div class="col-md-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <c:if test="${p.status == 0}">
                                    <form method="post" action="${pageContext.request.contextPath}/v1/manager/salary/confirm-own" class="m-0">
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/v1/manager/salary/report-own" class="m-0">
                                        <input type="hidden" name="payrollId" value="${p.payrollId}">
                                        <input type="hidden" name="month" value="${selectedMonth}">
                                        <input type="hidden" name="year" value="${selectedYear}">
