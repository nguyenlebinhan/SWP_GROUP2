        ...
        <div class="dept-header">
            ...
            <div>
                <c:if test="${canEditDepts}">
                    <a href="${pageContext.request.contextPath}/v1/employee/department/update?id=${department.departmentId}" 
                        ...
                        <tbody>
                            <c:forEach var="emp" items="${employees}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/v1/employee/employee_info/detail?id=${emp.employeeId}"
