        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex gap-2">
                <c:if test="${canEditEmployee}">
                    <a class="btn btn-outline-primary btn-sm" href="${pageContext.request.contextPath}/v1/employee/employee_info/update?id=${employee.employeeId}">
                ...
                <c:if test="${canAddEmploymentContract}">
                    ...
                    <a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/v1/employee/contract/add?employeeId=${employee.employeeId}">
