...
<div class="main">
    <div class="no-print">
        <jsp:include page="/public/components/employeeTopBar.jsp">
            ...
            <jsp:param name="backUrl" value="/v1/employee/employee-detail?id=${employee.employeeId}" />
        </jsp:include>
    </div>

    <div class="toolbar no-print">
        <a href="${pageContext.request.contextPath}/v1/employee/employee-detail?id=${employee.employeeId}" class="btn btn-outline-secondary btn-sm">
