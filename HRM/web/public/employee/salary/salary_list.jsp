    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="filter-card">
                <form method="get" action="${pageContext.request.contextPath}/v1/employee/salary/all" class="row g-3 align-items-end">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <a href="${pageContext.request.contextPath}/v1/employee/salary/all" class="btn btn-outline-secondary w-100">Xóa lọc</a>
                    </div>
                </form>
            </div>
